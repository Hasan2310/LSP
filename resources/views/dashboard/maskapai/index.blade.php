        ...
        <table class="min-w-full bg-white border border-gray-200 shadow-md rounded-md overflow-hidden">
            ...
            <tbody>
                @foreach ($maskapais as $maskapai)
                    <tr class="border-t">
                        <td class="px-6 py-4 text-gray-800">{{ $maskapai->id }}</td>
                        ...
                        <td class="px-6 py-4 text-gray-800">{{ $maskapai->jam_berangkat }}</td>
                        <td class="px-6 py-4 text-gray-800">{{ $maskapai->jam_tiba }}</td>
