...
<div class="max-w-4xl mx-auto mt-10 bg-white p-8 rounded-lg shadow-md">
    ...
    <form action="{{ route('maskapais.update', $maskapai->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <!-- Kota Keberangkatan -->
            <div>
                <label for="kota_keberangkatan" class="block text-sm font-medium text-gray-700 mb-1">Kota Keberangkatan</label>
                <input type="text" name="kota_keberangkatan" id="kota_keberangkatan" value="{{ $maskapai->kota_keberangkatan }}"
                    class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    required>
            </div>
            ...
            <div>
                ...
                <input type="time" name="jam_berangkat" id="jam_berangkat" value="{{ $maskapai->jam_berangkat }}"
                    class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    required>
            </div>
            ...
            <div>
                ...
                <input type="time" name="jam_tiba" id="jam_tiba" value="{{ $maskapai->jam_tiba }}"
                    class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    required>
            </div>
            ...
            <div>
                ...
                <input type="number" name="kapasitas_kursi" id="kapasitas_kursi" value="{{ $maskapai->kapasitas_kursi }}"
                    class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
